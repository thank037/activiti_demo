package com.xiefayang.g_sequenceFlow;
...
public class SequenceFlowTest {
	...
	public void deploymentProcessDefinition(){
		...
		Deployment deployment = processEngine.getRepositoryService() 
				...
				.name("连线") //添加部署的名称
				.addClasspathResource("diagrams/sequenceFlow.bpmn") //从classpath中加载资源, 一次只能加载一个
...
//				.startProcessInstanceById(processDefinitionId)  
	...
	public void completePersonalTask(){
		...
		varablies.put("message", "重要");
		/**
		 * 完成任务的同时, 设置流程变量
		 * 流程变量是用来指定完成任务后, 下一个连线的去向.对应xxx.bpmn中的表达式'${message==xx}'
		 */
